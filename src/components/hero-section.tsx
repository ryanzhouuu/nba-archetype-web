...
export default function HeroSection() {
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      {/* Hero content */}
      <div className="z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center gap-4 rounded-2xl">
        <div className="flex flex-row justify-center items-center gap-8">
          <svg
            width={150}
            height={150}
            viewBox="0 0 150 150"
            className="object-contain border-2 border-black rounded-xl"
            aria-label="NBA Logo"
          >
            <image href="/nba-logo.svg" width="150" height="150" />
          </svg>
          <h1 className="text-6xl font-bold text-gray-900 whitespace-nowrap">
            Archetype Clustering
          </h1>
        </div>
        <p className="text-xl text-gray-700 text-center max-w-2xl leading-relaxed font-semibold">
